...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css-admin/styles-blogadd.css">
  ...
  <body>
    ...
    <section id="breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          <li> <a href="index-admin.jsp"></a> Trang quảng trị</li>
                                ...
                                <td >
                                    ...
                                    <table id="blog_add_form" class="form">
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:TextBox runat="server" type="text" size="100" id="txtUserName"></asp:TextBox>
                                            <asp:Label ID="lblUserName" runat="server"></asp:Label>
                                            </td>
                                            
                                        </tr>
                                         <tr>
                                            <th>Tên tin tức :<span class="note"></span><input value="An toàn khi trượt patin"></th>
                                        </tr>
                                        <tr>
                                            <th>   Tiêu đề :<span class="note">*</span><input style="margin-left:25px ;" value="MŨ BẢO HỘ PATIN FAST FOWARD"></th>
                                        </tr>
                                       
                                       
                                        <tr >
                                            <th ><h4 style="font-weight: 150%">Hình ảnh:</h4>
                                                <span> <img src="../image-admin/sp5.jpg" / style="width: 300px;height: 250px;padding-top:20px ;margin-left: 39px; "></span>
                                           </th>
                                        </tr>
                                        <tr>
                                            <th>Nội dung:<span class="note"></span><textarea rows="7" cols="70" value="">Trọng lượng của nón bảo hộ Fast Foward nhẹ sắp xỉ 200g, nhưng bảo vệ đâu cực tốt, các lỗ thông gió trên nón thiết kế phù hợp về mặt khí động học giúp lướt gió và thoải mái đầu.
Có nút chỉnh size đầu nên việc sợ rộng hay chật dường như là không cần quan tâm trên mẫu nón bảo hộ này.
Mẫu mã hợp thời trang, với các màu trắng, đen, xanh cho bạn dễ lựa chọn màu phù hợp với chính mình.</textarea></th>
