            ...
            <div class="breadcrumb-container">
                <div class="container">
                    <div class="breadcrumbs"><a href="https://www.patinchinhhang.com/">Home</a><span
                            class="separator">/</span><span> Đăng nhập</span></div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    <div class="form">
                                        ...
                                        <div class="links">
                                            <a href="#"><i class="fa-solid fa-question"></i> Quên mật khẩu</a>
                                            <a href="dangky.html"><i class="fa-solid fa-user-plus"></i> Đăng ký</a>
                                        </div>
                                        <div class="inputBox">
