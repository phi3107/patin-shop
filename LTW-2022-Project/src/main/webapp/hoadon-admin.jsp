...
<body>
    ...
    <nav class="navbar navbar-default">
        <div class="container">
            ...
            <li  class="active"><a href="hoadon-admin.jsp">Quản lý hóa đơn</a></li>
    ...
    <section id="main">
        <div class="container">
            <div class="row">
              ...
              <a href="hoadon-admin.jsp" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Quản lý hóa đơn<span class="badge">5</span></a>
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>Nha Trang</td>
                                    <td>Đã giao </td>
                                    <td><a href="chitiethoadon-admin.jsp"><button>Xem..</button></a></td>
                                </tr>
                                <tr>
                                    <td>02</td>
                                    <td>HD-632</td>
