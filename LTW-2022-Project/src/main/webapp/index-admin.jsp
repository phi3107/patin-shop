      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="index-admin.jsp">Trang quản trị</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="index-admin.jsp" class="list-group-item active main-color-bg">
                ...
                <div class="panel-body">
                  <table class="table table-striped table-hover">
                    ...
                    <tr>
                      ...
                      <th>Nữ</th>
                      <th>034491929</th>
                      <td>sabg@yahoo.com</td>
                      <td>12-09-2017</td>
                      <td>Admin</td>
                    </tr>
                    <tr>
                      <td>GB-07</td>
                     <td>Nguyễn Phạm Long Phi</td>
                     <th>Nam</th>
                      <th>034491929</th>
                      <td>Longphi@yahoo.com</td>
                      <td>14-03-2018</td>
                      <td>Người dùng</td>
                    </tr>
                    <tr>
