      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          <li><a href="index-admin.jsp">Trang quản trị</a></li>
            ...
            <li  class="active"><a href="lienhe-admin.jsp">Liên hệ</a></li>
        </ul>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group">
            ...
            <a href="pages-admin.jsp" class="list-group-item"><span class="glyphicon glyphicon-list-alt"
                                                                    aria-hidden="true"></span> Quản lý trang <span class="badge">4</span></a>
            <a href="posts-admin.jsp" class="list-group-item"><span class="glyphicon glyphicon-pencil"
                                                                    aria-hidden="true"></span> Quản lý bài viết <span class="badge">6</span></a>
            <a href="users-admin.jsp" class="list-group-item"><span class="glyphicon glyphicon-user"
                                                                    aria-hidden="true"></span> Quản lý tài khoản <span class="badge">4</span></a>
            <a href="Customer-admin.jsp" class="list-group-item"><span class="glyphicon glyphicon-user"
                                                                       aria-hidden="true"></span> Quản lý khách hàng <span class="badge">8</span></a>
            <a href="product-admin.jsp" class="list-group-item"><span class="glyphicon glyphicon-shopping-cart"
                                                                      aria-hidden="true"></span> Quản lý sản phẩm <span class="badge">6</span></a>
            <a href="hoadon-admin.jsp" class="list-group-item"><span class="glyphicon glyphicon-book"
                                                                     aria-hidden="true"></span> Quản lý hóa đơn<span class="badge">5</span></a>
            <a href="lienhe-admin.jsp" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-envelope"
            ...
            <div class="panel-body">
              ...
              <table class="table table-striped table-hover">
                ...
                <tr>
                  <td>01</td>
                  <td>LH-235</td>
                  <td>Nguyễn Anh Đào</td>
                  <td>01020305564</td>
                  <td>zvz.anhdao,zvz@gmail.com</td>
                  <td>Đánh giá sản phẩm</td>
                  <td>Đánh giá: Sản phẩm tốt, xứng đáng với giá tiền bỏ ra, an toàn cho người dùng, nhưng sẽ phù hợp hơn với người đã biết trượt patin từ trước. Dịch vụ của shop rất tốt, thái độ nhân viên tốt. </td>
                  <td><img style="width: 60px; height: 20px;" src="image-admin/danhgia.jpg" alt=""></td>
                  <td>
                ...
                <tr>
                  ...
                  <td>Đánh giá sản phẩm</td>
                  <td>Đánh giá: Sản phẩm tốt, xứng đáng với giá tiền bỏ ra, an toàn cho người dùng, nhưng sẽ phù hợp hơn với người đã biết trượt patin từ trước. Dịch vụ của shop rất tốt, thái độ nhân viên tốt. </td>
                  <td><img style="width: 60px; height: 20px;" src="image/danhgia.jpg" alt=""></td>
                  <td>
                    <a  data-toggle="modal" data-target="#modalContactForm"  class="list-group-item"><span class="glyphicon glyphicon-send"
                      aria-hidden="true"></span></a>
                  </td>
