      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="pages-admin.jsp">Quản lý trang</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="pages-admin.jsp" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Quản lý trang <span class="badge">4</span></a>
                ...
                <table class="table table-striped table-hover">
                  <a type="button" data-toggle="modal" data-target="#addPage"> <button id="btn_them_post">Thêm trang mới</button></a>
                      ...
                      <tr>
                        ...
                        <td>Dec 12, 2016</td>
                        <td><a class="btn btn-default" class="list-group-item" href="edit-admin.jsp"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> <a class="btn btn-danger" class="list-group-item"
