...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css-admin/style-user.css">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="users-admin.jsp">Quản lý tài khoản</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="users-admin.jsp" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Quản lý tài khoản <span class="badge">4</span></a>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                  <a href="user_add-admin.jsp"> <button id="btn_them_user">Thêm tài khoản mới</button></a>
                      <tr>
                        <th>ID</th>
                        <th>Tên</th>
                        <th>Giới tính</th>
                      ...
                      <tr>
                        <th>TN-01</th>
                        <th>Nguyễn Anh Đào</th>
                        <th>Nữ</th>
                        <th>0368547789</th>
                        <th>zvz.anhdao.zvz@gmail.com</th>
                        <td>10-11-2016</td>                       
                        <th>Admin</th>
                        <td><a class="btn btn-default" class="list-group-item" href="user_add-admin.jsp"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> <a class="btn btn-danger" class="list-group-item"
                                                                                                                                                                                    href="#"><span class="glyphicon glyphicon-trash"></span></a></td>
                      </tr>
                      <tr>
                        <th>SR-03</th>
                        <th>Nguyễn Phạm Long Phi</th>
                        <th>Nam</th>
                        <th>034491929</th>
                        <th>longpham@gmail.com</th>
                        <th>12-09-2017</th>
                        <th>Admin</th>
                        <td><a class="btn btn-default" class="list-group-item" href="user_add-admin.jsp"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> <a class="btn btn-danger" class="list-group-item"
