      ...
      <div class="breadcrumb-container">
        <div class="container">
          <div class="breadcrumbs"><a href="https://www.patinchinhhang.com/">Home</a><span
                  class="separator">/</span><span> Đăng ký</span></div>
        </div>
      </div>
      <div class="container">
        <div class="row">
              ...
              <div id="grid__content">
                <div id="card">
                  <form class="form" action="signup" method="post">
                    ...
                    <div class="signup__field">
                      <label for="password-repeat" class="label">Nhập lại mật khẩu</label>
                    ...
                    <div class="signup__button">
                      <button id="submit" class="button" type="submit">Đăng ký</button>
                    </div>
