                  ...
                  <div id="card">
                    <form class="form" action="update-user" method="post">
                      ...
                      <div class="signup__button">
                        <button id="submit" class="button" type="submit">Cập nhật</button>
                      </div>
                    </form>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="category-tab col-12 col-sm-6 col-xl-3">
                    <a href=" https://www.patinchinhhang.com/danh-muc-san-pham/banh-xe/"> <img
                          ...
                          href="https://www.patinchinhhang.com/danh-muc-san-pham/banh-xe/">Bánh
                    xe</a>
                  </div>
                  <div class="category-tab col-12 col-sm-6 col-xl-3">
                  ...
                  <div class="category-tab col-12 col-sm-6 col-xl-3">
                    <a href=" https://www.patinchinhhang.com/danh-muc-san-pham/giay-patin/">
                      <img src="https://www.patinchinhhang.com/wp-content/uploads/2021/07/custom-leader-giay-patin-dua.jpg"
                          ...
                          href="https://www.patinchinhhang.com/danh-muc-san-pham/giay-patin/">Giày
                    patin</a>
                  </div>
                  <div class="category-tab col-12 col-sm-6 col-xl-3">
                  ...
                  <div class="category-tab col-12 col-sm-6 col-xl-3">
                    <a href=" https://www.patinchinhhang.com/danh-muc-san-pham/phu-kien/"> <img
                          ...
                          href="https://www.patinchinhhang.com/danh-muc-san-pham/phu-kien/">Phụ
                    kiện</a>
                  </div>
                  <div class="category-tab col-12 col-sm-6 col-xl-3">
                    <a href="https://www.patinchinhhang.com/danh-muc-san-pham/thuong-hieu/">Thương
                      hiệu</a>
                  </div>
                </div>
              ...
              <aside id="woocommerce_product_categories-1"
                ...
                <ul class="product-categories">
                  <li class="cat-item cat-item-245"><a
                          href="thongtinUser.html" style="font-weight: bold;">Thông tin tài khoản</a></li>
                  <li class="cat-item cat-item-123"><a
                          href="doimk.html">Đổi mật khẩu</a></li>
                  <li class="cat-item cat-item-15"><a
                          href="">Danh sách đơn hàng</a></li>
                </ul>
              </aside>
